...
<form method="post" action="Image_delete.php" enctype="multipart/form-data" style="margin-left: 43.5%; width: 40%;background: #FFFFFF;">
	<div style="margin-left: 2%; width: 40%;background: #FFFFFF;font-size:1.4vw"><?php echo "Просмотров: "."$views"; ?></div>
    <input name="Button_reg" type="submit" value="Удалить" style="width:200px;height:75px;font-size:1.4vw" />
